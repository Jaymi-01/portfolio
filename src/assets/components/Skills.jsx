...
import Reveal from "/src/assets/components/Reveal"
...
const skills = [
    {
      ...
      technologies: [
        ...
        { name: 'Tailwind', icon: <RiTailwindCssFill className='text-blue-900' /> },
    ...
    },
    {
      ...
      technologies: [
        { name: 'Firebase', icon: <RiFirebaseFill className='text-orange-500' /> },
        { name: 'Php', icon: <DiPhp className='text-blue-900' /> },
        { name: 'MySQL', icon: <SiMysql className="text-mysql" />},
      ],
    },
  ]
